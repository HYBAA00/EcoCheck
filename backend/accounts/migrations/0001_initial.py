    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('admin', 'Administrateur'), ('enterprise', 'Entreprise'), ('employee', 'Employé'), ('authority', 'Autorité')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supervisor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='supervised_employees', to=settings.AUTH_USER_MODEL)),
